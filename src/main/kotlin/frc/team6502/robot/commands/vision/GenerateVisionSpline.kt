...
class GenerateVisionSpline() : InstantCommand() {
    ...
    override fun execute() {
        ...
        val targetX = CollectVisionData.avgY - 17.inches.feet
        val targetY = -CollectVisionData.avgX - 11.inches.feet
        val targetA = -CollectVisionData.avgH
        ...
        RamseteFollowPath(t, 0.7, 0.2).start()
    }
}